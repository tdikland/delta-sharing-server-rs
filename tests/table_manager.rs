...
// async fn test_list_shares<M: Catalog>(manager: &M) {
...
// async fn test_get_share<M: Catalog>(manager: &M) {
...
//     assert_eq!(
//         non_existing_share,
//         CatalogError::ShareNotFound {
//             share_name: "absent".to_string()
//         }
//     );
// }

// async fn test_list_schemas<M: Catalog>(manager: &M) {
...
// async fn test_list_tables_in_share<M: Catalog>(manager: &M) {
...
// async fn test_list_tables_in_schema<M: Catalog>(manager: &M) {
//     // it should list up to 100 tables by default
//     let res1 = manager
...
// async fn test_get_table<M: Catalog>(manager: &M) {
