...
impl From<deltalake::kernel::Protocol> for Protocol {
    fn from(protocol: deltalake::kernel::Protocol) -> Self {
        Self {
...
impl From<deltalake::kernel::Metadata> for Metadata {
    // pub struct Metadata {
    ...
    fn from(metadata: deltalake::kernel::Metadata) -> Self {
        Self {
            id: metadata.id,
            name: metadata.name,
